...
![Tournament Welcome Screen](assets/preview/tournament-welcome.png)
...
![Tournament Step – Name](assets/preview/tournament-step-name.png)

#### Step 2 – Tournament Type

Choose between single elimination, double elimination, Swiss, or shuffle tournaments.

![Tournament Type – Single Elimination](assets/preview/tournament-type-single-elimination.png)
![Tournament Type – Double Elimination](assets/preview/tournament-type-double-elimination.png)
![Tournament Type – Shuffle Tournament](assets/preview/tournament-type-shuffle.png)

#### Step 3 – Match Format

Select the match format (Best of 1, Best of 3, Best of 5) for bracketed tournaments.

![Tournament Step – Match Format](assets/preview/tournament-step-format.png)

#### Step 4 – Maps / Map Pool

Pick a map pool or configure custom maps for the tournament.

![Tournament Step – Maps](assets/preview/tournament-step-maps.png)

#### Step 5 – Teams

Select which teams will participate in the tournament and quickly add all teams if needed.

![Tournament Step – Teams](assets/preview/tournament-step-teams.png)

#### Step 6 – Review

Review all tournament settings before creating the tournament and generating the bracket.

![Tournament Step – Review](assets/preview/tournament-step-review.png)
...
![Shuffle Tournament – Format Info](assets/preview/shuffle-tournament-format.png)
![Shuffle Tournament – Configuration](assets/preview/shuffle-tournament-config.png)
...
![Tournament Setup](assets/preview/tournament.png)
...
![Teams Management](assets/preview/teams.png)
...
![Select Player Modal](assets/preview/select-player-modal.png)
...
![Servers Management](assets/preview/servers.png)
...
![Bracket View](assets/preview/bracket.png)
...
![Matches Overview](assets/preview/matches.png)
...
![Team Match Page](assets/preview/team-page.png)
...
![Team Map Veto - Initial State](assets/preview/veto-process.png)

**After Actions** - After both teams have made their bans:

![Team Map Veto - After Actions](assets/preview/veto-process-action.png)

**Side Pick** - When teams need to pick their starting side (CT or T):

![Team Map Veto - Side Pick](assets/preview/veto-side-pick.png)
...
![Admin Tools](assets/preview/admin-tools.png)
...
![Players](assets/preview/players.png)
...
![Templates](assets/preview/templates.png)
...
![ELO Templates](assets/preview/elo-templates.png)
