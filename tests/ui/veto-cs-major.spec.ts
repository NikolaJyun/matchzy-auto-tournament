...
import { performVetoActionsUI, getCSMajorBO1UIActions, getCSMajorBO3UIActions } from '../helpers/vetoUI';
...
test.describe.serial('CS Major BO1 Veto - UI E2E', () => {
  ...
  test('should complete BO1 veto via UI and display correct side badges', {
